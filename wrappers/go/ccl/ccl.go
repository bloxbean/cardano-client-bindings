...
func (tb *TxBuilder) doBuild(providerConfig *ProviderConfig) (*TxResult, error) {
	...
	result, err := tb.bridge.invoke(func() C.int { return C.ccl_quicktx_build(tb.bridge.thread, cs) })
	if err != nil {
		return nil, err
	}
...
func (cb *ComposeTxBuilder) doBuild(providerConfig *ProviderConfig) (*TxResult, error) {
	...
	result, err := cb.bridge.invoke(func() C.int { return C.ccl_quicktx_build(cb.bridge.thread, cs) })
	if err != nil {
		return nil, err
	}
...
func (sb *ScriptTxBuilder) doBuild(providerConfig *ProviderConfig) (*TxResult, error) {
	...
	result, err := sb.bridge.invoke(func() C.int { return C.ccl_quicktx_build(sb.bridge.thread, cs) })
	if err != nil {
		return nil, err
	}
